 ...
 */
class CellDrawable {
	private static final Color WALL = MinecraftTheme.WALL_COLOR;
	private static final Color CURRENT = MinecraftTheme.CURRENT_COLOR;
	private static final Color START = MinecraftTheme.START_COLOR;
	private static final Color END = MinecraftTheme.END_COLOR;
	private static final Color SOLUTION = MinecraftTheme.SOLUTION_COLOR;
	private static final Color VISITING = MinecraftTheme.LAVA_ORANGE;
	private static final Color VISITED = MinecraftTheme.VISITED_COLOR;
